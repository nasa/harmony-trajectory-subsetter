/****************************************************************************
    This version of the HE5_GctpFunc.h file is required for
    geotiff_converter.h.
    It is manually added here because the latest version of the hdfeos5
    package is not yet available in conda at the time of this addition.
    24-May-08 - Josie Lyon
*****************************************************************************/
...
int for_init(int a, int b, double c[], int d, char *str1, char *str2, int *e, int (**func)(double, double, double *, double *));
int inv_init(int a,int b,double *c,int d,char *str1,char *str2,int *e,int (**func)(double, double, double*, double*));
