...
TEST(TestIndexSelection, AddSegmentCaseA1_PASS)
{
...
TEST(TestIndexSelection, AddSegmentCaseA1_FAIL)
{
...
TEST(TestIndexSelection, AddSegmentCaseA2_PASS)
{
...
TEST(TestIndexSelection, AddSegmentCaseA2_FAIL)
{
...
TEST(TestIndexSelection, AddSegmentCaseA3_PASS)
{
...
TEST(TestIndexSelection, AddSegmentCaseA3_FAIL)
{
...
TEST(TestIndexSelection, AddSegmentCaseB1_PASS)
{
...
TEST(TestIndexSelection, AddSegmentCaseB1_FAIL)
{
...
TEST(TestIndexSelection, AddSegmentCaseB2_PASS)
{
...
TEST(TestIndexSelection, AddSegmentCaseB2_FAIL)
{
...
TEST(TestIndexSelection, AddSegmentCaseB3_PASS)
{
...
TEST(TestIndexSelection, AddSegmentCaseB3_FAIL)
{
...
TEST(TestIndexSelection, AddSegmentEdge1CaseA2_PASS)
{
    /* Edge Cases */
...
TEST(TestIndexSelection, AddSegmentEdge1CaseA2_FAIL)
{
...
TEST(TestIndexSelection, AddSegmentEdge2CaseA2_PASS)
{
...
TEST(TestIndexSelection, AddSegmentEdge2CaseA2_FAIL)
{
...
TEST(TestIndexSelection, AddSegmentEdge3CaseA2_PASS)
{
...
TEST(TestIndexSelection, AddSegmentEdge3CaseA2_FAIL)
{
    // FAIL - Edge Case 1b : { + [ _ ] _ } : This test is an edge case that should be handled as a A2 case.
...
TEST(TestIndexSelection, AddSegmentEdge1CaseA3_PASS)
{
...
TEST(TestIndexSelection, AddSegmentEdge1CaseA3_FAIL)
{
...
TEST(TestIndexSelection, AddSegmentEdge2CaseA3_PASS)
{
...
TEST(TestIndexSelection, AddSegmentEdge2CaseA3_FAIL)
{
...
TEST(TestIndexSelection, AddSegmentEdge3CaseA3_FAIL)
{
    // FAIL - Edge Case 3 : [ + { _ } _ ] : This test is an edge case that should be handled as a A3 Case.
...
TEST(TestIndexSelection, AddSegmentEdgeCaseB1_PASS)
{
...
TEST(TestIndexSelection, AddSegmentEdgeCaseB2_PASS)
{
...
TEST(TestIndexSelection, AddSegmentEdgeCaseA3_FAIL)
{
    // FAIL - Edge Case 3 : { _ } + [ _ ] : This test is an edge case that should be handled as a A3 Case.
