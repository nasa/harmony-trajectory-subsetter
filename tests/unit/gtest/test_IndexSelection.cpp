...
TEST_F(IndexSelectionTest, AddSegmentCaseA1_PASS) {
  /* Simple Cases (overlap exists between new and existing segments, move right
   * to left) */
  std::cout << "*** IndexSelection::addSegment Unit Tests: Simple Test Cases "
...
TEST_F(IndexSelectionTest, AddSegmentEdge1CaseA2_PASS) {
  ...
  // PASS - Edge Case 1 : [ _ ] + { _ } : This test is an edge case that should
  // be handled as a A2 Case.
...
TEST_F(IndexSelectionTest, AddSegmentEdge1CaseA2_FAIL) {
  // FAIL - Edge Case 1 : [ _ ] + { _ } : This test is an edge case that should
  // be handled as a A2 Case. Change expectedResultEdgeCase1[3] = 17; for
  // segment not equal
  std::cout << "\tEdge Case 1 : [ _ ] + { _ }.\n";
...
TEST_F(IndexSelectionTest, AddSegmentEdge2CaseA2_PASS) {
  // PASS - Edge Case 1b : [ _ { _ ] + } : This test is an edge case that should
  // be handled as a A2 case.
...
TEST_F(IndexSelectionTest, AddSegmentEdge2CaseA2_FAIL) {
  // FAIL - Edge Case 1b : [ _ { _ ] + } : This test is an edge case that should
  // be handled as a A2 case. Change expectedResultEdgeCase1b[3] = 25; for
  // segment not equal
  std::cout << "\tEdge Case 1b : [ _ { _ ] + }.\n";
  this->indexes.addSegment(3, 5);                // [3,5] - existing segment
  this->indexes.addSegment(4, 4);                // {4,4} - new segment
...
TEST_F(IndexSelectionTest, AddSegmentEdge3CaseA2_PASS) {
  // PASS - Edge Case 2 : { + [ _ ] _ } : This test is an edge case that should
  // be handled as a A2 Case.
...
TEST_F(IndexSelectionTest, AddSegmentEdge3CaseA2_FAIL) {
  // FAIL - Edge Case 1b : { + [ _ ] _ } : This test is an edge case that should
  // be handled as a A2 case. Change expectedResultEdgeCase2[3] = 26; for
  // segment not equal
  std::cout << "\tEdge Case 2 : { + [ _ ] _ }.\n";
  this->indexes.addSegment(3, 5);               // [3,5] - existing segment
  this->indexes.addSegment(3, 6);               // {3,6} - new segment
...
TEST_F(IndexSelectionTest, AddSegmentEdge1CaseA3_PASS) {
  // PASS - Edge Case 3 : { _ [ _ ] + } : This test is an edge case that should
  // be handled as a A3 Case.
...
TEST_F(IndexSelectionTest, AddSegmentEdge1CaseA3_FAIL) {
  // FAIL - Edge Case 3 : { _ [ _ ] + } : This test is an edge case that should
  // be handled as a A3 Case. Change expectedResultEdgeCase2[3] = 26; for
  // segment not equal
  std::cout << "\tEdge Case 2 : { _ [ _ ] + }.\n";
  this->indexes.addSegment(3, 5);               // [3,5] - existing segment
  this->indexes.addSegment(3, 6);               // {3,6} - new segment
...
TEST_F(IndexSelectionTest, AddSegmentEdge2CaseA3_FAIL) {
  // FAIL - Edge Case 3 : { + [ _ ] + } : This test is an edge case that should
  // be handled as a A3 Case. Change expectedResultEdgeCase4[3] = 35; for
  // segment not equal
  std::cout << "\tEdge Case 4 : { + [ _ ] + }.\n";
  this->indexes.addSegment(3, 5);               // [3,5] - existing segment
  this->indexes.addSegment(3, 5);               // {3,5} - new segment
...
TEST_F(IndexSelectionTest, AddSegmentEdge3CaseA3_FAIL) {
  // FAIL - Edge Case 3 : [ + { _ } _ ] : This test is an edge case that should
  // be handled as a A3 Case. Change expectedResultEdgeCase4b[3] = 45; for
  // segment not equal
...
TEST_F(IndexSelectionTest, AddSegmentEdgeCaseB1_PASS) {
  // PASS - Edge Case 4b : [ + { _ } _ ] : This test is an edge case that should
  // be handled as a B1 case.
  std::cout << "\tEdge Case 4b : [ + { _ } _ ].\n";
  this->indexes.addSegment(3, 5);                // [3,5] - existing segment
  this->indexes.addSegment(3, 4);                // {3,4} - new segment
  std::map<long, long> expectedResultEdgeCase4b; // (3,5) - expected segment
...
TEST_F(IndexSelectionTest, AddSegmentEdgeCaseB2_PASS) {
  // PASS - Edge Case 5 : { _ } + [ _ ] : This test is an edge case that should
  // be handled as a B2 Case.
...
TEST_F(IndexSelectionTest, AddSegmentEdgeCaseA3_FAIL) {
  // FAIL - Edge Case 3 : { _ } + [ _ ] : This test is an edge case that should
  // be handled as a A3 Case. Change expectedResultEdgeCase5[1] = 77; for
  // segment not equal
  std::cout << "\tEdge Case 5 : { _ } + [ _ ].\n";
  this->indexes.addSegment(3, 5);               // [3,5] - existing segment
  this->indexes.addSegment(1, 2);               // {1,2} - new segment
