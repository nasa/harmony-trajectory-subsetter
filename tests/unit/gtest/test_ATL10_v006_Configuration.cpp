...
namespace 
{
    ...
    protected:
        void SetUp()
        {
            ...
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/freeboard_segment/beam_fb_confidence/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/freeboard_segment/beam_fb_height/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/freeboard_segment/beam_fb_quality_flag/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/freeboard_segment/beam_fb_unc/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/freeboard_segment/beam_refsurf_ndx/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/freeboard_segment/delta_time/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/freeboard_segment/geophysical/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/freeboard_segment/geoseg_beg");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/freeboard_segment/geoseg_end/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/freeboard_segment/height_segment_id/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/freeboard_segment/heights/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/leads/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/leads/ssh_n/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/leads/ssh_ndx/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/reference_surface_section/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/reference_surface_section/beam_fb_refsurf/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/reference_surface_section/beam_lead_n/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/reference_surface_section/beam_lead_ndx/");
            configuration_a->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1l/reference_surface_section/fbswath_ndx/");

            configuration_b = std::make_unique<Configuration>(configFile);
            configuration_b->addShortNameGroupDatasetFromGranuleFile(shortName, "/METADATA/Lineage/Control/");
            configuration_b->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1r/");
            configuration_b->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1r/freeboard_segment/");
            configuration_b->addShortNameGroupDatasetFromGranuleFile(shortName, "/gt1r/freeboard_segment/beam_fb_confidence/");

            configuration_c = std::make_unique<Configuration>(configFile);
            configuration_c->addShortNameGroupDatasetFromGranuleFile(shortName, "/METADATA/Lineage/Control/");
        }
    ...
    TEST_F(test_ATL10_v006_Configuration, ATL10_getTargetGroupname_isFreeboardRateGroup)
    {
        ...
        //Test /gt1l/freeboard_segment/
        std::string group = "/gt1l/freeboard_segment/";
        std::string groupname = configuration_a->getTargetGroupname(shortName, group);
        EXPECT_EQ(expectGroupname, groupname);
    ...
    TEST_F(test_ATL10_v006_Configuration, ATL10_getTargetGroupname_isReferenceSurfaceSectionGroup_isBeamIndex)
    {
        ...
        std::string groupname = configuration_a->getTargetGroupname(shortName, group, datasetName);
        EXPECT_EQ(expectGroupname, groupname);

        //Test /gt1l/reference_surface_section/
        group = "/gt1l/reference_surface_section/";
        groupname = configuration_a->getTargetGroupname(shortName, group, datasetName);
        EXPECT_EQ(expectGroupname, groupname);
    }
    ...
    TEST_F(test_ATL10_v006_Configuration, ATL10_getIndexBeginDatasetName_isLeadsGroup)
    {
        ...
        groupname = configuration_a->getIndexBeginDatasetName(shortName, group, datasetName);
        EXPECT_EQ(expectGroupname, groupname);
    }
    ...
    TEST_F(test_ATL10_v006_Configuration, ATL10_getIndexBeginDatasetName_isReferenceSurfaceSectionGroup_isSwathHeightIndex)
    {
        ...
        std::string group = "/gt1l/reference_surface_section/";
        std::string datasetName = "fbswath_ndx";
        std::string groupname = configuration_a->getIndexBeginDatasetName(shortName, group, datasetName);
        EXPECT_EQ(expectGroupname, groupname);
    }
    ...
    TEST_F(test_ATL10_v006_Configuration, ATL10_getIndexBeginDatasetName_isReferenceSurfaceSectionGroup_BeamIndex)
    {
        ...
        bool repair = true;
        std::string groupname = configuration_a->getIndexBeginDatasetName(shortName, group, datasetName, repair);
        EXPECT_EQ(expectGroupname, groupname);

        datasetName = "beam_fb_length";
        groupname = configuration_a->getIndexBeginDatasetName(shortName, group, datasetName, repair);
        EXPECT_EQ(expectGroupname, groupname);
    }
    ...
    TEST_F(test_ATL10_v006_Configuration, ATL10_getCountDatasetName_isLeadsGroup)
    {
        ...
        std::string datasetName = "lead_height";
        groupname = configuration_a->getCountDatasetName(shortName, group, datasetName);
        EXPECT_EQ(expectGroupname, groupname);
    }
    ...
    TEST_F(test_ATL10_v006_Configuration, ATL10_isShortNameGrougInH5File)
    {
        ...
        std::string group = "/gt1l/reference_surface_section/";
        bool bisShortNameGrougInH5File = configuration_a->isShortNameGroupDatasetFromGranuleFile(shortName, group);
        EXPECT_TRUE(bisShortNameGrougInH5File);

        group = "/gt1l/leads/";
        bisShortNameGrougInH5File = configuration_a->isShortNameGroupDatasetFromGranuleFile(shortName, group);
        EXPECT_TRUE(bisShortNameGrougInH5File);
